...
df['speedup'] = df['scib-metrics'] / df['scib']

print('Speedup of scib-metrics over scib')
print(df)
...
g = sns.catplot(
    ...
    title='Speedup of scib-metrics over scib',
    xscale='log'
)
g.set_axis_labels('t scib-metrics / scib', 'Metric')
