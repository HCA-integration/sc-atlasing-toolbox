# copied and modified from https://github.com/scverse/rapids_singlecell/blob/v0.10.2/src/rapids_singlecell/tools/_clustering.py
...
def louvain(
    ...
    *,
    ...
    # Cluster
    if packaging_version.parse(version("cugraph")) >= packaging_version.parse("23.08.00"):
