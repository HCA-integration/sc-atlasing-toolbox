...
use rule cluster from clustering as clustering_cluster with:
    ...
    params:
        ...
        algorithm=lambda wildcards: mcfg.get_from_parameters(wildcards, 'algorithm', default='louvain'),
    resources:
...
use rule plots from preprocessing as clustering_plot_umap with:
    ...
    params:
        ...
        color=lambda wildcards: [
            f"{mcfg.get_from_parameters(wildcards, 'algorithm', default='louvain')}_{resolution}"
